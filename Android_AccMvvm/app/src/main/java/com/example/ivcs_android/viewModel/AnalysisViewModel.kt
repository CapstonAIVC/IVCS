...
import com.example.ivcs_android.CctvPickDialogFragment
...
class AnalysisViewModel(application: Application, fragmentManager : FragmentManager ) : AndroidViewModel(application) {
